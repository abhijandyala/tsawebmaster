    ...
    <div className="relative h-[100dvh] min-h-0 max-h-[100dvh] flex flex-col overflow-hidden bg-[#0d1210]">
      ...
      <main className="relative z-20 flex-1 flex flex-col items-center justify-center min-h-0 px-6 pb-6 sm:pb-8 text-center">
        ...
        >
          ...
          >
            <div className="inline-flex w-fit max-w-full items-center justify-center rounded-2xl bg-white px-2.5 py-1.5 sm:px-3 sm:py-2 shadow-[0_4px_28px_rgba(0,0,0,0.18)] ring-1 ring-black/[0.06]">
              <Image
                src="/cltlogotext.png"
                alt="Charlotte Connect"
                width={300}
                height={96}
                className="block w-[min(300px,82vw)] h-auto"
                priority
              />
            </div>
          </motion.div>
